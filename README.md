...
<h3 align="center">Solmira Linux</h3>
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/Solmira-Linux/SolmiraLinux"><strong>Explore the docs »</strong></a>
    <br />
    <br />
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin Solmira-Linux/SolmiraLinux
...
[license-url]: https://github.com/Solmira-Linux/SolmiraLinux/blob/master/LICENSE.txt
